    ...
    <div id="dcWrap">
        <div id="dcHead">
            <div id="head">
                ...
                <div class="nav">
                    ...
                    <ul class="navRight">
                        @if (Auth::guest())
                            <li class="M noLeft"><a href="{{ url('/login') }}">Login</a></li>
                            <li class="M noLeft"><a href="{{ url('/register') }}">Register</a></li>
                        @else
                            <li class="M noLeft"><a href="JavaScript:void(0);">您好，{{ Auth::user()->name }}</a>
        ...
        <div id="dcLeft">
            <div id="menu">
                ...
                <ul>
                    <li><a href="{{url('admin/user')}}"><i class="manager"></i><em>顾客管理</em></a></li>
                </ul>
                <ul>
                    <li><a href="{{url('admin/order')}}"><i class="page"></i><em>订单管理</em></a></li>
                </ul>
                <ul>
                    <li><a href="{{url('admin/cate')}}"><i class="product"></i><em>菜品分类</em></a></li>
                    <li><a href="{{url('admin/food')}}"><i class="articleCat"></i><em>菜品列表</em></a></li>
                </ul>
                <ul>
                    <li><a href="{{url('admin/shop')}}"><i class="nav"></i><em>店铺管理</em></a></li>
